package com.yanxiu.gphone.jiaoyan.customize.aggregate.wave;
...
class Wave extends View {
    ...
    public void initializePainters() {
        ...
        //设置渐变色区域
        int[] colors = {Color.parseColor("#42beff"), Color.parseColor("#dd66ff")};
        LinearGradient shader = new LinearGradient(0, 0, 1500, 0, colors, null, Shader.TileMode.CLAMP);
        mAboveWavePaint.setShader(shader);
        mBlowWavePaint.setShader(shader);
