 ...
 */
public class MineMyCertUnFinishPresenter
        extends BaseRecyclerFragmentPresenter<MineMyCertUnFinishContract.IView>
        implements MineMyCertUnFinishContract.IPresenter{
    public MineMyCertUnFinishPresenter(MineMyCertUnFinishContract.IView view) {
        super(view);
    }
