...
import static com.test.yanxiu.common_base.ui.toolbar.Utils.getActionBarHeight;
import static com.test.yanxiu.common_base.ui.toolbar.Utils.getStatusBarHeight;
...
public class Builder {
    ...
    public Builder addTitleImage(CommonToolbar.OnImageLoaderListener listener) {
        mToolbar.setTitleImage(listener);
        return this;
    }

    public Builder addTitleImage(int width, int height, CommonToolbar.OnImageLoaderListener listener) {
