package com.test.yanxiu.common_base.utils.serverUrl;
...
public class UrlBean implements Serializable {
    ...
    public String getQiNiuUploadUrl() {
        return qiNiuUploadUrl;
    }

    public void setQiNiuUploadUrl(String qiNiuUploadUrl) {
        this.qiNiuUploadUrl = qiNiuUploadUrl;
    }
